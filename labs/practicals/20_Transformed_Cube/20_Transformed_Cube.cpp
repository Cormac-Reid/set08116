...
bool load_content() {
  ...
  vector<vec3> positions{
	  ...
	  // Back
	  vec3(0.0f , 0.0f , -1.0f) , vec3(0.0f , 1.0f , -1.0f) , vec3(1.0f , 1.0f , -1.0f) ,
	  vec3(0.0f , 0.0f , -1.0f) , vec3(1.0f , 1.0f , -1.0f) , vec3(1.0f , 0.0f , -1.0f) ,
	  // Right
	  vec3(1.0f , 0.0f , 0.0f) , vec3(1.0f , 1.0f , -1.0f) , vec3(1.0f , 1.0f , 0.0f) ,
	  vec3(1.0f , 0.0f , 0.0f) , vec3(1.0f , .0f , -1.0f) , vec3(1.0f , 1.0f , -1.0f) ,
	  // Left
	  vec3(0.0f , 0.0f , 0.0f) , vec3(0.0f , 1.0f , 0.0f) , vec3(0.0f , 1.0f , -1.0f) ,
	  vec3(0.0f , 0.0f , 0.0f) , vec3(0.0f , 1.0f , -1.0f) , vec3(0.0f , 0.0f , -1.0f) ,
	  // Top
	  vec3(0.0f , 1.0f , 0.0f) , vec3(1.0f , 1.0f , -1.0f) , vec3(0.0f , 1.0f , -1.0f) ,
	  vec3(0.0f , 1.0f , 0.0f) , vec3(1.0f , 1.0f , 0.0f) , vec3(1.0f , 1.0f , -1.0f) ,
	  // Bottom
	  vec3(0.0f , 0.0f , 0.0f) , vec3(1.0f , 0.0f , -1.0f) , vec3(1.0f , 0.0f , 0.0f) ,
	  vec3(0.0f , 0.0f , 0.0f) , vec3(0.0f , 0.0f , -1.0f) , vec3(1.0f , 0.0f , -1.0f)
      // *********************************
  };
  // Colours
  vector<vec4> colours;
